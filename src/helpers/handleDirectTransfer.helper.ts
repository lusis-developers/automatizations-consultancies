...
export async function handleDirectTransfer(body: DirectTransferBody, res: Response): Promise<void> {
  try {
    ...
    res.status(500).json({ message: 'Error procesando la transferencia directa' })
  }
}
